...
Execute this in a terminal with `python main.py` and voilá! (also, if you ever wondered why many website ask you if "you're a human" is because scripts like this 😉):
...
Try it yourself: <a href="https://chat.openai.com/share/1bc40a55-e970-45ff-b369-0b78bf2e1cc4" target="_blank">Mechanical Óscar A. Montiel</a>.
