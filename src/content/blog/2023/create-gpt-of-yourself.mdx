...
import img2 from "@/images/blog/2023/create-gpt-of-yourself/python-selenium-scrap.png";
...
Here is the code (I need to use **pdfkit** to convert it into a PDF and some encoding stuff to make sure the font is correctly embedded in the PDF as UTF-8):
