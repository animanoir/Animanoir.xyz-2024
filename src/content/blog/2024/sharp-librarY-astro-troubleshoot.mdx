...
Use `bun` instead of `yarn` to install your dependencies... And _voilá_! Everything works again. We should start ditching `yarn` and all Facebook "technologies" for good.
