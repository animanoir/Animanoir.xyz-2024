...
[metaxis.digital](https://metaxis.digital/) is an online magazine that serves as a confluence of philosophy and futurism,
dissected and discussed from a metamodern perspective.
...
It is worth noting that it implements the [Are.na](https://www.are.na/degrees-degrees-bullet-period/metaxis-digital) API to fetch the content of the channel that serves as the main source of inspiration for the project. This allows for a seamless integration between the platform and the channel, which is constantly updated with new content.
